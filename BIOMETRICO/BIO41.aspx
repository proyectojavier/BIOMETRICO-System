<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Plantilla.Master" CodeBehind="BIO41.aspx.vb" Inherits="BIOMETRICO.BIO41" %>
                                    ...
                                    <asp:Panel ID="Panel1" runat="server" Height="200px" >
                                        <div class="col-md-6 col-lg-4">
											<div class="form-group">
                                                ...
                                                <asp:TextBox ID="txtCodigo" runat="server" class="form-control" placeholder="Código de Modelo" Font-Size="Larger" Enabled="False"></asp:TextBox>
											</div>
											<div class="form-group">
												<asp:Label ID="lblDescripcion" runat="server" Text="Descripción del Modelo" Font-Bold="True"></asp:Label><p></p>
                                                <asp:TextBox ID="txtDescripcion" runat="server" class="form-control" placeholder="Descripción del Modelo" required MaxLength="20"></asp:TextBox>
											</div>
										</div>
                                    </asp:Panel>
								  </div>
